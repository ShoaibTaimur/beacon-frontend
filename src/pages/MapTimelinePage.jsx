  ...
  const stops = useMemo(() => {
    ...
    for (let i = 1; i < history.length; i++) {
      ...
      if (dist <= 50) {
        ...
        const durationMs = new Date(currentGroup[currentGroup.length - 1].timestamp) - new Date(currentGroup[0].timestamp);
            ...
            <div className="mt-4 bg-neutral-900/60 border border-neutral-900 rounded-2xl p-4 shadow-xl backdrop-blur-md z-30">
              ...
              {activePoint && (
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mt-3 pt-3 border-t border-neutral-800/60 text-xs">
                  ...
                  {activePoint.locationAccuracy !== null && (
                    <div>
                      <div className="text-neutral-500">Accuracy</div>
                      <div className="font-semibold text-cyan-400">± {activePoint.locationAccuracy.toFixed(1)} m</div>
                    </div>
                  )}
                  <div>
